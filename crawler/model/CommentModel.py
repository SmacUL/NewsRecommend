class CommentModel:
    ...
    def __init__(self):
        ...
        self.com_time = None
        self.com_identify_id = None
        self.com_legal = 1

    def set(self, com_id, com_content, com_like_num, com_customer_id, com_article_id, com_time, com_identify_id):
        self.com_id = com_id
        ...
        self.com_identify_id = com_identify_id
        self.com_legal = 1
